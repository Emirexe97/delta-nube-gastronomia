...
const api: DesktopApi = {
  ...
  listCashSessionHistory: () => invoke("listCashSessionHistory"),
  getCashSessionReport: (filters) => invoke("getCashSessionReport", filters),
  ...
  applyOrderDeposit: (input) => invoke("applyOrderDeposit", input),
  ...
  settleCustomerAccount: (input) => invoke("settleCustomerAccount", input),
  ...
  createFloorPlanShape: (input) => invoke("createFloorPlanShape", input),
  updateFloorPlanShape: (input) => invoke("updateFloorPlanShape", input),
  deleteFloorPlanShape: (input) => invoke("deleteFloorPlanShape", input),
